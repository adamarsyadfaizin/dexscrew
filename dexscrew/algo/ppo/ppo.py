...
from dexscrew.utils.misc import AverageScalarMeter
...
class PPO(object):
    def __init__(self, env, output_dif, full_config):
        ...
        self.proprio_dim = self.ppo_config['proprio_dim']
        ...
        self.storage = ExperienceBuffer(
            ...
            self.actions_num, self.priv_info_dim, self.point_cloud_buffer_dim, self.device,
        ...
        for _ in range(0, self.mini_epochs_num):
            ...
            for i in range(len(self.storage)):
                value_preds, old_action_log_probs, advantage, old_mu, old_sigma, \
                    returns, actions, obs, priv_info, point_cloud_info, proprio_hist = self.storage[i]
